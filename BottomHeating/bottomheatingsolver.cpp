...
void BottomHeatingSolver::output()
{
    ...
    for(int i = 0; i < ny; i++)
        for(int j = 0; j < nx; j++)
            ostream << x[j] << " " << y[i] << " " << omega[i][j] << endl;
    file.close();
